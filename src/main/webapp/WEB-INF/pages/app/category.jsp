...
<h3>Questions for category "${currentCategory.name}"</h3>
<div id="questions">
  <c:forEach var="question" items="${questions}">
    <article class="question question-type-normal">
      ...
      <div class="question-inner">
        ...
        <span class="question-view"><i class="icon-user"></i>${question.views} view</span>
        <div class="clearfix"></div>
      </div>
    </article>
  </c:forEach>
...
<script>
  $(document).ready(function () {
    ...
    function loadMoreQuestions(page) {
      ...
      $.ajax({
        type: "GET",
        url: "<c:url value="/loadMoreByCategory" />",
        data: {id: ${currentCategory.id}, page: page},
